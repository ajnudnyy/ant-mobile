...
export default class ManipulatorMaintain extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div className= "HomeView">
          ...
          <Row className='statesFosize'>
            <Col xs={18} md={12}>
              <div className={'my-pretty-chart-container'}>
                ...
                <div id="led1" style={{fontSize:0,backgroundColor:'#333'}}></div>
        ...
        <Footer Component="Manipulatorfooter ManipulatorMaintain" />
      </div>
    )
  }
}