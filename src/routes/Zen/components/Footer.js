...
export const Footer = (props) => (
	<div className={props.Component}>
		<Link className="column first" to='/zen'><img src={Monitor} />&nbsp;监视</Link>
		<Link className="column second" to='#'><img src={maintain} />&nbsp;维护</Link>
		<Link className="column third" to='#'><img src={setting} />&nbsp;设定</Link>
